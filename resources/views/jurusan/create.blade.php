    ...
    <div class="p-6">
        <form action="{{ route('jurusan.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <small class="text-gray-500">Contoh: TI, SI, MJ, AK, HK</small>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="deskripsi" rows="4"
                          class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500">{{ old('deskripsi') }}</textarea>
            </div>
