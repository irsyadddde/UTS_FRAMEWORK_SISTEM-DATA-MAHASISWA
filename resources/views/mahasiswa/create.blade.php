        ...
        <form action="{{ route('mahasiswa.store') }}" method="POST">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama_mahasiswa" required maxlength="100"
                           class="w-full border rounded-lg px-4 py-2 focus:outline-none focus:border-blue-500"
            ...
            <div class="flex gap-3 mt-4">
                ...
                <a href="{{ route('mahasiswa.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded-lg transition">
