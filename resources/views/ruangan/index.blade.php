...
<div class="bg-white rounded-lg shadow">
    ...
    <div class="p-6">
        <form method="GET" class="mb-4 flex gap-2">
            ...
            <button type="submit" class="bg-gray-500 text-white px-6 py-2 rounded-lg">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                <a href="{{ route('ruangan.show', $r->id) }}" class="text-blue-500"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('ruangan.edit', $r->id) }}" class="text-green-500"><i class="fas fa-edit"></i></a>
                    ...
                    @empty
                    <tr><td colspan="7" class="px-6 py-4 text-center">Tidak ada data</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
        <div class="mt-4">{{ $ruangans->links() }}</div>
    </div>
</div>
@endsection